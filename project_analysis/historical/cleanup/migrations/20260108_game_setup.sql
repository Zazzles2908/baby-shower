-- ============================================================================
-- MOM VS DAD GAME SETUP MIGRATION
-- Creates database functions and tables for game functionality
-- ============================================================================
...
INSERT INTO supabase.schema_migrations (version, inserted_at) 
VALUES ('20260108_game_setup', NOW())
