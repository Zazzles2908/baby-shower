...
```mermaid
graph TD
    A[Root Level] --> B[README.md - Executive Summary]
    A --> C[PRODUCTION_CHECKLIST.md - Pre-event Verification]
    A --> D[docs/ - Main Documentation Directory]
    
    D --> E[docs/technical/ - Technical Documentation]
    E --> F[ARCHITECTURE.md - System Design]
    E --> G[DEPLOYMENT.md - Complete Deployment Guide]
    E --> H[TESTING.md - Testing Guide]
    E --> I[SETUP.md - Initial Setup]
    E --> J[TROUBLESHOOTING.md - Common Issues]
    
    D --> K[docs/reference/ - Reference Materials]
    K --> L[SCHEMA.md - Database Schema]
    K --> M[EDGE_FUNCTIONS.md - API Specifications]
    K --> N[API.md - API Documentation]
    K --> O[ENVIRONMENT.md - Environment Variables]
    
    D --> P[docs/historical/ - Archived Analysis]
    P --> Q[CRITICAL_ANALYSIS_2026-01-02.md]
    P --> R[DETAILED_FIX_PLAN.md]
    P --> S[DATABASE_SCHEMA_ANALYSIS.md]
    P --> T[PLANS.md]
    P --> U[GOOGLE_SHEETS_INTEGRATION_VERIFICATION.md]
    
    D --> V[docs/testing/ - Testing Docs]
    V --> W[E2E_TEST_REPORT.md]
    V --> X[E2E_TEST_STRATEGY.md]
```
