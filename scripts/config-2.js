...
try {
  ...
  const CONFIG = {
    ...
    SUPABASE: {
      ENABLED: true, URL: 'https://bkszmvfsfgvdwzacgmfz.supabase.co',
    ...
    MILESTONES: {
      ...
      POOL_10: 10, POOL_20: 20, QUIZ_25: 25, QUIZ_50: 50,
      ADVICE_10: 10, ADVICE_20: 20, VOTES_50: 50
    },
    BABY_NAMES: ['Emma', 'Olivia', 'Sophia', 'Charlotte', 'Amelia', 'Ava', 'Mia', 'Isabella', 'Lily', 'Harper'],
    QUIZ_ANSWERS: {
      puzzle1: 'Baby Shower', puzzle2: 'Three Little Pigs',
      puzzle3: 'Rock a Bye Baby', puzzle4: 'Baby Bottle', puzzle5: 'Diaper Change'
    },
    STORAGE: {
  ...
  console.error('❌ config-2.js failed to load:', error.message);
